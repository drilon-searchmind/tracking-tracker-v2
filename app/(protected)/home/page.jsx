        ...
        <section id="pageHomePage" className="py-20">
            <div className="grid grid-cols-12 gap-x-20 items-start relative">
                ...
                <span className="col-span-6">
                    <h4 class="mb-4.5 text-lg font-light text-zinc-700 dark:text-white">Searchmind Core - Home</h4>
                    <h1 className="mb-5 pr-16 text-3xl font-bold text-black xl:text-[44px] inline-grid z-10">Welcome to Your <span className="bg-titlebg relative w-full bottom-0 z-10">Searchmind Core</span> Homepage</h1>
